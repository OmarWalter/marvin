import { af as a } from "../entries/pages_catch-all.DAV0Q7Rp.js";
function i(t) {
  return a({
    tag: "svg",
...
function h(t) {
  return a({
    ...
    attr: { viewBox: "0 0 24 24" },
    child: [
      { tag: "path", attr: { d: "m10.998 16 5-4-5-4v3h-9v2h9z" }, child: [] },
      {
        tag: "path",
        attr: {
...
function r(t) {
  return a({
    ...
    attr: { viewBox: "0 0 24 24" },
    child: [
      { tag: "path", attr: { d: "M16 12h2v4h-2z" }, child: [] },
      {
        tag: "path",
        attr: {
...
export { h as B, l as a, d as b, r as c, i as d };
