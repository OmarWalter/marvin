...
/* empty css                                                               */ /* empty css                                                                      */ /* empty css                                                                                        */ /* empty css                                                                                    */ /* empty css                                                   */ const te =
    "@firebase/installations",
  N = "0.6.20";
const ne = 1e4,
  ae = `w:${N}`,
  ie = "FIS_v2",
  Pe = "https://firebaseinstallations.googleapis.com/v1",
  _e = 60 * 60 * 1e3,
  De = "installations",
  Fe = "Installations";
const Oe = {
...
function se({ projectId: e }) {
  return `${Pe}/projects/${e}/installations`;
}
function oe(e) {
  return {
    token: e.token,
...
function $e(e, { refreshToken: t }) {
  const n = le(e);
  return n.append("Authorization", Ne(t)), n;
}
async function ue(e) {
  const t = await e();
...
async function Le({ appConfig: e, heartbeatServiceProvider: t }, { fid: n }) {
  const a = se(e),
    i = le(e),
  ...
  const s = { fid: n, authVersion: ie, appId: e.appId, sdkVersion: ae },
    o = { method: "POST", headers: i, body: JSON.stringify(s) },
...
function je() {
  try {
    ...
    (self.crypto || self.msCrypto).getRandomValues(e),
      (e[0] = 112 + (e[0] % 16));
    const n = Ue(e);
    return qe.test(n) ? n : F;
  } catch {
    return F;
  }
}
function Ue(e) {
  return xe(e).substr(0, 22);
}
function R(e) {
...
function Ge() {
  return (
    !w &&
      ...
      ((w = new BroadcastChannel("[Firebase] FID Change")),
      (w.onmessage = (e) => {
...
const ze = "firebase-installations-database",
  He = 1,
...
async function C(e, t) {
  const n = R(e),
    i = (await L()).transaction(y, "readwrite"),
    r = i.objectStore(y),
    s = await r.get(n);
  return (
    await r.put(t, n), await i.done, (!s || s.fid !== t.fid) && pe(e, t.fid), t
  );
}
async function me(e) {
  const t = R(e),
    a = (await L()).transaction(y, "readwrite");
...
async function P(e, t) {
  const n = R(e),
    ...
    o = t(s);
  return (
    o === void 0 ? await r.delete(n) : await r.put(o, n),
    await i.done,
    o && (!s || s.fid !== o.fid) && pe(e, o.fid),
    o
  );
}
async function x(e) {
  let t;
  const n = await P(e.appConfig, (a) => {
    const i = Ke(a),
      r = We(e, i);
...
function Ke(e) {
  const t = e || { fid: je(), registrationStatus: 0 };
  return he(t);
}
function We(e, t) {
...
async function Ye(e, t) {
  try {
    ...
    return C(e.appConfig, n);
  } catch (n) {
    throw (
      (re(n) && n.customData.serverCode === 409
        ? await me(e.appConfig)
        : await C(e.appConfig, { fid: t.fid, registrationStatus: 0 }),
      n)
    );
  }
}
async function Je(e) {
  ...
  for (; t.registrationStatus === 1; )
    await de(100), (t = await B(e.appConfig));
  if (t.registrationStatus === 0) {
...
async function Qe({ appConfig: e, heartbeatServiceProvider: t }, n) {
  ...
  const s = { installation: { sdkVersion: ae, appId: e.appId } },
    o = { method: "POST", headers: i, body: JSON.stringify(s) },
    c = await ue(() => fetch(a, o));
  if (c.ok) {
    const l = await c.json();
...
async function q(e, t = !1) {
  let n;
  const a = await P(e.appConfig, (r) => {
    if (!we(r)) throw I.create("not-registered");
    const s = r.authToken;
    if (!t && nt(s)) return r;
    if (s.requestStatus === 1) return (n = et(e, t)), r;
    {
...
async function et(e, t) {
  let n = await G(e.appConfig);
  for (; n.authToken.requestStatus === 1; )
    await de(100), (n = await G(e.appConfig));
  const a = n.authToken;
  return a.requestStatus === 0 ? q(e, t) : a;
}
function G(e) {
  return P(e, (t) => {
    if (!we(t)) throw I.create("not-registered");
    const n = t.authToken;
    return rt(n) ? { ...t, authToken: { requestStatus: 0 } } : t;
  });
}
async function tt(e, t) {
  try {
    const n = await Qe(e, t),
      a = { ...t, authToken: n };
    return await C(e.appConfig, a), n;
  } catch (n) {
    if (
      re(n) &&
...
function nt(e) {
  return e.requestStatus === 2 && !at(e);
}
function at(e) {
  const t = Date.now();
  return t < e.creationTime || e.creationTime + e.expiresIn < t + _e;
}
function it(e) {
...
async function st(e) {
  ...
  return a ? a.catch(console.error) : q(t).catch(console.error), n.fid;
}
async function ot(e, t = !1) {
  const n = e;
  return await ct(n), (await q(n, t)).token;
}
async function ct(e) {
...
function lt(e) {
  if (!e || !e.options) throw D("App Configuration");
  if (!e.name) throw D("App Name");
  const t = ["projectId", "apiKey", "appId"];
  for (const n of t) if (!e.options[n]) throw D(n);
  return {
    appName: e.name,
...
const Ie = "installations",
  ...
  ft = (e) => {
    const t = e.getProvider("app").getImmediate(),
      n = E(t, Ie).getImmediate();
    return { getId: () => st(n), getToken: (i) => ot(n, i) };
  };
function pt() {
  v(new S(Ie, dt, "PUBLIC")), v(new S(ut, ft, "PRIVATE"));
}
pt();
A(te, N);
A(te, N, "esm2020");
...
function yt(e) {
  if (!e.startsWith(j)) {
    const t = d.create("invalid-gtag-resource", { gtagURL: e });
    return u.warn(t.message), "";
  }
  return e;
}
function ye(e) {
...
function Tt(e, t) {
  const n = bt("firebase-js-sdk-policy", { createScriptURL: yt }),
    a = document.createElement("script"),
    i = `${j}?l=${e}&id=${t}`;
  (a.src = n ? (n == null ? void 0 : n.createScriptURL(i)) : i),
    (a.async = !0),
...
async function vt(e, t, n, a, i, r) {
  const s = a[i];
  try {
    if (s) await t[s];
    else {
      const c = (await ye(n)).find((l) => l.measurementId === i);
      c && (await t[c.appId]);
    }
  } catch (o) {
    u.error(o);
...
function kt(e, t, n, a, i) {
  ...
  return (
    window[i] && typeof window[i] == "function" && (r = window[i]),
    (window[i] = Ct(r, e, t, n)),
...
function Et(e) {
  ...
  for (const n of Object.values(t))
    if (n.src && n.src.includes(j) && n.src.includes(e)) return n;
  return null;
}
const Rt = 30,
  Pt = 1e3;
...
async function Ft(e) {
  ...
  const { appId: t, apiKey: n } = e,
    a = { method: "GET", headers: Dt(n) },
    i = wt.replace("{app-id}", t),
    r = await fetch(i, a);
  if (r.status !== 200 && r.status !== 304) {
    let o = "";
    try {
      const c = await r.json();
      (s = c.error) != null && s.message && (o = c.error.message);
    } catch {}
...
async function Ot(e, t = be, n) {
  ...
  return (
    ...
    Te({ appId: a, apiKey: i, measurementId: r }, s, o, t)
  );
}
async function Te(e, { throttleEndTimeMillis: t, backoffCount: n }, a, i = be) {
  var o;
  ...
  try {
    ...
    if (s)
      return (
        ...
        { appId: r, measurementId: s }
      );
    throw c;
  }
  try {
    const c = await Ft(e);
    return i.deleteThrottleMetadata(r), c;
  } catch (c) {
    const l = c;
    if (!Mt(l)) {
      if ((i.deleteThrottleMetadata(r), s))
        return (
          u.warn(
    ...
    const f =
        Number(
          (o = l == null ? void 0 : l.customData) == null
            ? void 0
            : o.httpStatus
        ) === 503
          ? U(n, i.intervalMillis, Rt)
          : U(n, i.intervalMillis),
      m = { throttleEndTimeMillis: Date.now() + f, backoffCount: n + 1 };
    return (
      i.setThrottleMetadata(r, m),
      u.debug(`Calling attemptFetch again in ${f} millis`),
      Te(e, m, a, i)
    );
  }
}
function $t(e, t) {
  return new Promise((n, a) => {
    ...
    e.addEventListener(() => {
      clearTimeout(r),
        a(d.create("fetch-throttle", { throttleEndTimeMillis: t }));
    });
  });
}
function Mt(e) {
...
async function xt(e, t, n, a) {
  if (a && a.global) return e("set", { screen_name: n }), Promise.resolve();
  {
    const i = await t;
    e("config", i, { update: !0, screen_name: n });
  }
}
async function qt(e, t, n, a) {
  if (a && a.global) return e("set", { user_id: n }), Promise.resolve();
  {
    const i = await t;
    e("config", i, { update: !0, user_id: n });
  }
}
async function jt(e, t, n, a) {
  if (a && a.global) {
    ...
    const i = await t;
    e("config", i, { update: !0, user_properties: n });
  }
}
...
async function Gt() {
  if (Z())
    try {
      ...
      return (
        u.warn(
          d.create("indexeddb-unavailable", {
...
async function Vt(e, t, n, a, i, r, s) {
  ...
  o
    .then((h) => {
      (n[h.measurementId] = h.appId),
        e.options.measurementId &&
          h.measurementId !== e.options.measurementId &&
          u.warn(
            `The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${h.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`
          );
    })
    .catch((h) => u.error(h)),
    t.push(o);
  const c = Gt().then((h) => {
    ...
    [l, f] = await Promise.all([o, c]);
  Et(r) || Tt(r, l.measurementId),
    $ && (i("consent", "default", $), Ae(void 0)),
    i("js", new Date());
  const m = (s == null ? void 0 : s.config) ?? {};
  return (
    (m[mt] = "firebase"),
    (m.update = !0),
    f != null && (m[gt] = f),
    i("config", l.measurementId, m),
    O && (i("set", O), ve(void 0)),
    l.measurementId
  );
}
...
let T = "dataLayer",
  ...
  M = !1;
function sn(e) {
  if (M) throw d.create("already-initialized");
  e.dataLayerName && (T = e.dataLayerName), e.gtagName && (Se = e.gtagName);
}
function Ht() {
  const e = [];
  if (
    (X() && e.push("This is a browser extension environment."),
    Q() || e.push("Cookies are not available."),
    e.length > 0)
  ) {
    const t = e.map((a, i) => `(${i + 1}) ${a}`).join(" "),
      n = d.create("invalid-analytics-context", { errorInfo: t });
    u.warn(n.message);
  }
}
function Kt(e, t, n) {
  ...
  if (p[a] != null) throw d.create("already-exists", { id: a });
  if (!M) {
    At(T);
    const { wrappedGtag: r, gtagCore: s } = kt(p, V, z, T, Se);
    (g = r), (H = s), (M = !0);
  }
  return (p[a] = Vt(e, V, z, t, H, T, n)), new zt(e);
}
function on(e = Ee()) {
  e = b(e);
  const t = E(e, k);
  return t.isInitialized() ? t.getImmediate() : Wt(e);
}
function Wt(e, t = {}) {
  const n = E(e, k);
  if (n.isInitialized()) {
...
function ln(e, t, n) {
  (e = b(e)), xt(g, p[e.app.options.appId], t, n).catch((a) => u.error(a));
}
async function un(e) {
  return (e = b(e)), Ut(g, p[e.app.options.appId]);
}
function dn(e, t, n) {
  (e = b(e)), qt(g, p[e.app.options.appId], t, n).catch((a) => u.error(a));
}
function Yt(e, t, n) {
  (e = b(e)), jt(g, p[e.app.options.appId], t, n).catch((a) => u.error(a));
}
function fn(e, t) {
  (e = b(e)), Bt(p[e.app.options.appId], t).catch((n) => u.error(n));
}
function pn(e) {
  g ? g("set", e) : ve(e);
}
function Jt(e, t, n, a) {
  (e = b(e)), Lt(g, p[e.app.options.appId], t, n, a).catch((i) => u.error(i));
}
function gn(e) {
  g ? g("consent", "update", e) : Ae(e);
}
...
function Xt() {
  v(
    ...
    v(new S("analytics-internal", e, "PRIVATE")),
    A(K, W),
    A(K, W, "esm2020");
  function e(t) {
    try {
      ...
      return {
        logEvent: (a, i, r) => Jt(n, a, i, r),
        setUserProperties: (a, i) => Yt(n, a, i),
      };
    } catch (n) {
      throw d.create("interop-component-reg-failed", { reason: n });
    }
  }
}
Xt();
export {
  on as getAnalytics,
  un as getGoogleAnalyticsClientId,
  Wt as initializeAnalytics,
  cn as isSupported,
  Jt as logEvent,
  fn as setAnalyticsCollectionEnabled,
  gn as setConsent,
  ln as setCurrentScreen,
  pn as setDefaultEventParameters,
  dn as setUserId,
  Yt as setUserProperties,
  sn as settings,
};
