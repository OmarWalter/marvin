  ...
  function t(t, e) {
    try {
      if ("true" === window.localStorage.plausible_ignore)
        return (
          (a = e),
          (n = "localStorage flag") && console.warn("Ignoring Event: " + n),
    ...
    var a,
      ...
      i =
        ((n.n = t),
        (n.u = o.href),
        (n.d = l.getAttribute("data-domain")),
        (n.r = r.referrer || null),
    ...
    ("auxclick" === t.type && t.button !== u) ||
      ...
      (i = e) &&
        ...
        !(function (t, e) {
          ...
          ? plausible(t.name, { props: t.props })
          : (plausible(t.name, { props: t.props, callback: r }),
            setTimeout(r, 5e3),
            i.preventDefault())));
  }
